...
https://github.com/cmcquinn/cookiecutter-django-iot
...
INSTALLED_APPS = (
    ...
    # local apps
    '{{ cookiecutter.repo_name }}.apps.devices',
    '{{ cookiecutter.repo_name }}.apps.observations',
    '{{ cookiecutter.repo_name }}.apps.interactions',
)
